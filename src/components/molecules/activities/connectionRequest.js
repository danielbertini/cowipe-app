...
import { PersonAddRounded as ActivityIcon } from "@material-ui/icons";
...
const MoleculesActivitiesConnectionRequest = (props) => {
...
export default memo(MoleculesActivitiesConnectionRequest);
