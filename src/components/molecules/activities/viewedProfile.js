...
import { VisibilityRounded as ActivityIcon } from "@material-ui/icons";
...
const MoleculesActivitiesViewedProfile = (props) => {
...
export default memo(MoleculesActivitiesViewedProfile);
